...
var r3dfb_selectFlipbok = [
  { label: __("Select Flipbook", "real3d-flipbook"), value: "" },
];

if (typeof r3dfb !== "undefined" && Array.isArray(r3dfb)) {
  // for (var i = 0; i < r3dfb.length; i++) {
  for (var i = r3dfb.length - 1; i >= 0; i--) {
    var b = r3dfb[i];
    if (b.id) {
      if (b.name == "") b.name = __("(no title)", "real3d-flipbook");
      r3dfb_selectFlipbok.push({ label: b.id + " " + b.name, value: b.id });
    }
  }
}
...
registerBlockType(
  ...
  {
    title: __("Real3D FlipBook", "real3d-flipbook"), // Block title. __() function allows for internationalization.
    description: __("Display PDF or images as flipbook", "real3d-flipbook"),
    ...
    category: "media", // Block category. Group blocks together based on common traits E.g. text, media, design, widgets, theme, embed.
    attributes: {
      id: {
        type: "string",
      },
    ...
    edit: function (props) {
      ...
      return [
        ...
        el(SelectControl, {
          //   label: "Select pre made flipbook",
          value: attributes.id,
        ...
        el(
          ...
          el(
            ...
            el(SelectControl, {
              label: __("Select Flipbook", "real3d-flipbook"),
              value: attributes.id,
              options: r3dfb_selectFlipbok,
              onChange: onChangeId,
            }),
